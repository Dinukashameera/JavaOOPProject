...
<body class="animsition">
	...
	<header class="header1">
		...
		<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m"
			style="background-image: url(images/productcover1.jpg);">
			<h2 class="l-text2 t-center">MUSIC</h2>
			<p class="m-text13 t-center">New Arrivals Instruments Collection 2019</p>
		</section>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
						<div class="leftbar p-r-20 p-r-0-sm">
							...
							<ul class="p-b-54">
								...
								<li class="p-t-4"><a
									href="${pageContext.request.contextPath}/Category?page=brass"
									class="s-text13"> Brass </a></li>

								<li class="p-t-4"><a
									href="${pageContext.request.contextPath}/Category?page=percussion"
									class="s-text13"> Percussion </a></li>

								<li class="p-t-4"><a
									href="${pageContext.request.contextPath}/Category?page=woodwind"
									class="s-text13"> Woodwind </a></li>

								<li class="p-t-4"><a
									href="${pageContext.request.contextPath}/Category?page=string"
									class="s-text13"> String </a></li>
							</ul>
							...
							<div class="filter-color p-t-22 p-b-50 bo3">
								...
								<ul class="flex-w">
									<ul class="p-b-54">
										...
										<li class="p-t-4"><a href="#" class="s-text13"> Shure
										</a></li>
					...
					<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
						...
						<!-- HERE WE ARE DISPLAYING THE DETAILS OF THE PRODUCTS -->
							...
							<div>
								...
								<div class="block2">
									...
									<div
										...
										<img src="./ImageDownloader?id=<%=id%>" alt="IMG-PRODUCT">
										...
										<div class="block2-overlay trans-0-4">
											...
											<div class="block2-btn-addcart w-size1 trans-0-4">
												<!-- Button -->
												<button
													class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4" type = "submit">
													Add to Cart
												</button>
									...
									<div class="block2-txt p-t-20">
										<a href="product-detail.html"
											class="block2-name dis-block s-text3 p-b-5"> <%=name%>
										</a> <span class="block2-price m-text6 p-r-5"> <%=price%>
											</form>
											<%
												} //end of for loop
											%>
